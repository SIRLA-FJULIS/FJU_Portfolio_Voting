"""
Django settings for Portfolio_Voting project.
...
SECRET_KEY = '#+o7becd9xaot4j=ajhpcnch62^dh5vg8qh^21t6zhms^=avoa'
...
ROOT_URLCONF = 'Portfolio_Voting.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.processor.save_visitor_infos',
            ],
        },
    },
]
